...
export function getRecommend () {
  ...
  // const url = debug ? '/api/getTopBanner' : 'http://123.57.140.129:9000/api/getTopBanner'
  const url = debug ? '/api/getTopBanner' : 'http://123.57.140.129/music/api/getTopBanner'
...
export function getDiscList () {
  ...
  // const url = debug ? '/api/getDiscList' : 'http://123.57.140.129:9000/api/getDiscList'
  const url = debug ? '/api/getDiscList' : 'http://123.57.140.129/music/api/getDiscList'
...
export function getSongList (disstid) {
  ...
  // const url = debug ? '/api/getCdInfo' : 'http://123.57.140.129:9000/api/getCdInfo'
  const url = debug ? '/api/getCdInfo' : 'http://123.57.140.129/music/api/getCdInfo'
